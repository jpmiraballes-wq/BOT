...
ENDURECIDO_V2 (2026-04-22): tras analisis forense de perdidas por
iliquidez, subimos filtros agresivamente. Ahora solo entran mercados
con liquidez real y resolucion proxima.
"""
...
def scan_markets():
    ...
    logger.info("Escaner (V2 endurecido) filtro %d oportunidades; top %d",
