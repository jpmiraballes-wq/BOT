...
from paper_maker_shallow_touch_shadow import run_shallow_touch_shadow_cycle
...
def archive_current_sample() -> str:
    ...
    archive_dir = data_dir / f'archive_v9_3_clean_{stamp}'
    ...
    manifest = {
        ...
        'reason': 'clean V9.3 shallow-touch live-shadow sample',
        'moved': moved,
    }
...
if __name__ == '__main__':
    ...
    result = run_shallow_touch_shadow_cycle()
